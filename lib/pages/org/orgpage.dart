...
import 'package:layer/pages/org/bountypageorg.dart';
import 'package:layer/pages/org/jobpageorg.dart';
import 'package:layer/pages/org/grantspageorg.dart';
...
class OrgPage extends StatelessWidget {
  ...
  child: Row(
    ...
    children: const [
      Icon(Icons.add, size: 40), // Adds the icon to the button
  ...
  onPressed: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: ((context) {
                    return GrantsPageOrg();
                  })));
                },
  style: ElevatedButton.styleFrom(
    primary: const Color.fromRGBO(167, 139, 250, 1), // Sets the background color
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(20), // Sets the border radius
    ),
  ),
