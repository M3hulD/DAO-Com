...
class MarketingEmployees extends StatefulWidget {
  const MarketingEmployees({super.key});

  @override
  State<MarketingEmployees> createState() => _MarketingEmployeesState();
}

class _MarketingEmployeesState extends State<MarketingEmployees> {
  String name = '';
  var department;
  var email;
  var walletAddress;
  ...
  Future<List<Result>> getEmployees() async {
    http.Response response =
        await http.get(Uri.parse("https://daocom.onrender.com/employees/filter/Marketing"));
